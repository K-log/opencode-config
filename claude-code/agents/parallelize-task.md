...
description: >-
  ...
  - <example>
      ...
      <commentary>
      Since the user wants to restructure a plan into parallel tasks, use the parallelize-task agent.
      </commentary>
    </example>
  - <example>
...
or by a planning workflow. You do not implement code and you never create or
