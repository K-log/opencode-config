...
3. If still unresolved, use the `question` tool to ask the user which branch to use as the base.
...
Present the exact command that will be executed to the user via the `question` tool before running anything:
